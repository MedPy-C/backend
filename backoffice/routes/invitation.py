...
invitation_routes = [
    path('user/<str:user_login_code>/groups/<str:slug_name>/invitation/', invitation.InvitationView.as_view(
        {'post': 'create',
         'get': 'list'}), name='user_invitation'),
    path('user/<str:user_login_code>/groups/<str:slug_name>/invitations/', invitation.InvitationView.as_view(
